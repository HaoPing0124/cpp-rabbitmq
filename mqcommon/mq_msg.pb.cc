...
const uint32_t TableStruct_mq_5fmsg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::haoping::BasicProperties, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::haoping::BasicProperties, id_),
  PROTOBUF_FIELD_OFFSET(::haoping::BasicProperties, delivery_mode_),
  PROTOBUF_FIELD_OFFSET(::haoping::BasicProperties, routing_key_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::haoping::Message_Payload, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::haoping::Message_Payload, properties_),
  PROTOBUF_FIELD_OFFSET(::haoping::Message_Payload, body_),
  PROTOBUF_FIELD_OFFSET(::haoping::Message_Payload, valid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::haoping::Message, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::haoping::Message, payload_),
  PROTOBUF_FIELD_OFFSET(::haoping::Message, offset_),
  PROTOBUF_FIELD_OFFSET(::haoping::Message, length_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::haoping::BasicProperties)},
  { 9, -1, -1, sizeof(::haoping::Message_Payload)},
  { 18, -1, -1, sizeof(::haoping::Message)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::haoping::_BasicProperties_default_instance_._instance,
  &::haoping::_Message_Payload_default_instance_._instance,
  &::haoping::_Message_default_instance_._instance,
};

const char descriptor_table_protodef_mq_5fmsg_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014mq_msg.proto\022\007haoping\"`\n\017BasicProperti"
  "es\022\n\n\002id\030\001 \001(\t\022,\n\rdelivery_mode\030\002 \001(\0162\025."
  "haoping.DeliveryMode\022\023\n\013routing_key\030\003 \001("
  "\t\"\252\001\n\007Message\022)\n\007payload\030\001 \001(\0132\030.haoping"
  ".Message.Payload\022\016\n\006offset\030\002 \001(\r\022\016\n\006leng"
  "th\030\003 \001(\r\032T\n\007Payload\022,\n\nproperties\030\001 \001(\0132"
  "\030.haoping.BasicProperties\022\014\n\004body\030\002 \001(\t\022"
  "\r\n\005valid\030\003 \001(\t*B\n\014ExchangeType\022\017\n\013UNKNOW"
  "NTYPE\020\000\022\n\n\006DIRECT\020\001\022\n\n\006FANOUT\020\002\022\t\n\005TOPIC"
  "\020\003*;\n\014DeliveryMode\022\017\n\013UNKNOWNMODE\020\000\022\r\n\tU"
  "NDURABLE\020\001\022\013\n\007DURABLE\020\002b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_mq_5fmsg_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_mq_5fmsg_2eproto = {
    false, false, 431, descriptor_table_protodef_mq_5fmsg_2eproto,
    "mq_msg.proto",
...
BasicProperties::BasicProperties(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:haoping.BasicProperties)
}
BasicProperties::BasicProperties(const BasicProperties& from)
  ...
  // @@protoc_insertion_point(copy_constructor:haoping.BasicProperties)
}
...
BasicProperties::~BasicProperties() {
  // @@protoc_insertion_point(destructor:haoping.BasicProperties)
...
// @@protoc_insertion_point(message_clear_start:haoping.BasicProperties)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "haoping.BasicProperties.id"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          CHK_(ptr);
          _internal_set_delivery_mode(static_cast<::haoping::DeliveryMode>(val));
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "haoping.BasicProperties.routing_key"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* BasicProperties::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:haoping.BasicProperties)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_routing_key().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "haoping.BasicProperties.routing_key");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:haoping.BasicProperties)
  return target;
}

size_t BasicProperties::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:haoping.BasicProperties)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:haoping.BasicProperties)
...
// @@protoc_insertion_point(class_specific_copy_from_start:haoping.BasicProperties)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class Message_Payload::_Internal {
 public:
  static const ::haoping::BasicProperties& properties(const Message_Payload* msg);
};
...
Message_Payload::Message_Payload(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:haoping.Message.Payload)
}
Message_Payload::Message_Payload(const Message_Payload& from)
  ...
  // @@protoc_insertion_point(copy_constructor:haoping.Message.Payload)
}
...
Message_Payload::~Message_Payload() {
  // @@protoc_insertion_point(destructor:haoping.Message.Payload)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:haoping.Message.Payload)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "haoping.Message.Payload.body"));
        } else
          goto handle_unusual;
        continue;
      // string valid = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "haoping.Message.Payload.valid"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Message_Payload::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:haoping.Message.Payload)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:haoping.Message.Payload)
  return target;
}

size_t Message_Payload::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:haoping.Message.Payload)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:haoping.Message.Payload)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:haoping.Message.Payload)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class Message::_Internal {
 public:
  static const ::haoping::Message_Payload& payload(const Message* msg);
};

const ::haoping::Message_Payload&
...
Message::Message(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:haoping.Message)
}
Message::Message(const Message& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_payload()) {
    payload_ = new ::haoping::Message_Payload(*from.payload_);
  } else {
    payload_ = nullptr;
  }
  ...
  // @@protoc_insertion_point(copy_constructor:haoping.Message)
}
...
Message::~Message() {
  // @@protoc_insertion_point(destructor:haoping.Message)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
void Message::Clear() {
// @@protoc_insertion_point(message_clear_start:haoping.Message)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* Message::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:haoping.Message)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:haoping.Message)
  return target;
}

size_t Message::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:haoping.Message)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:haoping.Message)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (from._internal_has_payload()) {
    _internal_mutable_payload()->::haoping::Message_Payload::MergeFrom(from._internal_payload());
  }
...
// @@protoc_insertion_point(class_specific_copy_from_start:haoping.Message)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::haoping::BasicProperties*
Arena::CreateMaybeMessage< ::haoping::BasicProperties >(Arena* arena) {
  return Arena::CreateMessageInternal< ::haoping::BasicProperties >(arena);
}
template<> PROTOBUF_NOINLINE ::haoping::Message_Payload*
Arena::CreateMaybeMessage< ::haoping::Message_Payload >(Arena* arena) {
  return Arena::CreateMessageInternal< ::haoping::Message_Payload >(arena);
}
template<> PROTOBUF_NOINLINE ::haoping::Message*
Arena::CreateMaybeMessage< ::haoping::Message >(Arena* arena) {
  return Arena::CreateMessageInternal< ::haoping::Message >(arena);
}

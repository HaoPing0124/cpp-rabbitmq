...
TEST(route_test, legal_routing_key)
{
    ...
    ASSERT_EQ(haoping::Router::isLegalRoutingKey(rkey1), true);
    ASSERT_EQ(haoping::Router::isLegalRoutingKey(rkey2), true);
    ASSERT_EQ(haoping::Router::isLegalRoutingKey(rkey3), false);
    ASSERT_EQ(haoping::Router::isLegalRoutingKey(rkey4), true);
}
TEST(route_test, legal_binding_key)
{
    ...
    ASSERT_EQ(haoping::Router::isLegalBindingKey(bkey1), true);
    ASSERT_EQ(haoping::Router::isLegalBindingKey(bkey2), true);
    ASSERT_EQ(haoping::Router::isLegalBindingKey(bkey3), false);
    ASSERT_EQ(haoping::Router::isLegalBindingKey(bkey4), false);
    ASSERT_EQ(haoping::Router::isLegalBindingKey(bkey5), false);
    ASSERT_EQ(haoping::Router::isLegalBindingKey(bkey6), true);
    ASSERT_EQ(haoping::Router::isLegalBindingKey(bkey7), false);
}
TEST(route_test, route)
{
    ...
    {
        ASSERT_EQ(haoping::Router::route(haoping::ExchangeType::TOPIC, rkeys[i], bkeys[i]), result[i]);
    }
}

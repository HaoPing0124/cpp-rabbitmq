...
haoping::ConsumerManager::ptr cmp;
...
public:
    ...
    {
        cmp = std::make_shared<haoping::ConsumerManager>();
...
void cb(const std::string &tag, const haoping::BasicProperties *bp, const std::string &body)
{
...
{
    haoping::Consumer::ptr cp = cmp->choose("queue1");

...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::contacts::contact, sno_),
...
contact::contact(const contact& from)
  ...
  ::memcpy(&sno_, &from.sno_,
    static_cast<size_t>(reinterpret_cast<char*>(&score_) -
    reinterpret_cast<char*>(&sno_)) + sizeof(score_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&sno_) - reinterpret_cast<char*>(this)),
...
// @@protoc_insertion_point(message_clear_start:contacts.contact)
  ...
  name_.ClearToEmpty();
  ::memset(&sno_, 0, static_cast<size_t>(
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          sno_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* contact::_InternalSerialize(
  ...
  // uint64 sno = 1;
  if (this->_internal_sno() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(1, this->_internal_sno(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:contacts.contact)
  ...
  // uint64 sno = 1;
  if (this->_internal_sno() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_sno());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:contacts.contact)
  ...
  if (from._internal_sno() != 0) {
    _internal_set_sno(from._internal_sno());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
...
void contact::InternalSwap(contact* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(contact, sno_)>(
          reinterpret_cast<char*>(&sno_),
          reinterpret_cast<char*>(&other->sno_));
}

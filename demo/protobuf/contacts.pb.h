...
class contact final :
 ...
 public:
  ...
  void clear_sno();
  uint64_t sno() const;
  void set_sno(uint64_t value);
  private:
  uint64_t _internal_sno() const;
  void _internal_set_sno(uint64_t value);
  public:
...
// uint64 sno = 1;
inline void contact::clear_sno() {
  sno_ = uint64_t{0u};
}
inline uint64_t contact::_internal_sno() const {
  return sno_;
}
inline uint64_t contact::sno() const {
  // @@protoc_insertion_point(field_get:contacts.contact.sno)
  return _internal_sno();
}
inline void contact::_internal_set_sno(uint64_t value) {
  
  sno_ = value;
}
inline void contact::set_sno(uint64_t value) {
  _internal_set_sno(value);
  // @@protoc_insertion_point(field_set:contacts.contact.sno)
}
